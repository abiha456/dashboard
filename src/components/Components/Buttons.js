const Buttons = () => {
    return(
        ...
        <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Buttons</h1>
        </div>
        <div className="row">
            <div className="col-lg-6">
                <div className="card shadow mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <a href="/" className="btn btn-primary btn-circle mr-2">
                            <i className="fa fa-facebook-f"></i>
                        </a>
                        <a href="/" className="btn btn-success btn-circle mr-2">
                            <i className="fa fa-check"></i>
                        </a>
                        <a href="/" className="btn btn-info btn-circle mr-2">
                            <i className="fa fa-info-circle"></i>
                        </a>
                        <a href="/" className="btn btn-warning btn-circle mr-2">
                            <i className="fa fa-exclamation-triangle"></i>
                        </a>
                        <a href="/" className="btn btn-danger btn-circle mr-2">
                            <i className="fa fa-trash"></i>
                        </a>
                        <div className="mt-4 mb-2">
                            <code>.btn-circle .btn-sm</code>
                        </div>
                        <a href="/" className="btn btn-primary btn-circle mr-2 btn-sm">
                            <i className="fa fa-facebook-f"></i>
                        </a>
                        <a href="/" className="btn btn-success btn-circle mr-2 btn-sm">
                            <i className="fa fa-check"></i>
                        </a>
                        <a href="/" className="btn btn-info btn-circle mr-2 btn-sm">
                            <i className="fa fa-info-circle"></i>
                        </a>
                        <a href="/" className="btn btn-warning btn-circle mr-2 btn-sm">
                            <i className="fa fa-exclamation-triangle"></i>
                        </a>
                        <a href="/" className="btn btn-danger btn-circle mr-2 btn-sm">
                            <i className="fa fa-trash"></i>
                        </a>
                        <div className="mt-4 mb-2">
                            <code>.btn-circle .btn-lg</code>
                        </div>
                        <a href="/" className="btn btn-primary btn-circle mr-2 btn-lg">
                            <i className="fa fa-facebook-f"></i>
                        </a>
                        <a href="/" className="btn btn-success btn-circle mr-2 btn-lg">
                            <i className="fa fa-check"></i>
                        </a>
                        <a href="/" className="btn btn-info btn-circle mr-2 btn-lg">
                            <i className="fa fa-info-circle"></i>
                        </a>
                        <a href="/" className="btn btn-warning btn-circle mr-2 btn-lg">
                            <i className="fa fa-exclamation-triangle"></i>
                        </a>
                        <a href="/" className="btn btn-danger btn-circle mr-2 btn-lg">
                            <i className="fa fa-trash"></i>
                        </a>
                    </div>
                </div>
                <div className="card shadow mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <p>You can create more custom buttons by adding a new color variable in the
                            ...
                            file.</p>
                        <a href="/" className="btn btn-google btn-block"><i className="fa fa-google fa-fw"></i>
                            .btn-google</a>
                        <a href="/" className="btn btn-facebook btn-block"><i
                                className="fa fa-facebook-f fa-fw"></i> .btn-facebook</a>
